...
def main():
    ...
    # input_pkt_cnt_list = call_and_parse_packet_cnt_input_ifd(dut_host, intf_list)
    # output_pkt_cnt_list = call_and_parse_packet_cnt_output_ifd(dut_host, intf_list)
    ...
    for intf in intf_list:
        # print(f'Interface {intf_list[i]} - Input packets: {input_pkt_cnt_list[i]}')
        # print(f'Interface {intf_list[i]} - Output packets: {output_pkt_cnt_list[i]}')
